  ...
  exports.default = Ember.Component.extend(_emberComposabilityTools.ChildMixin, _emberInvokeAction.InvokeActionMixin, {
    ...
    requiredOptions: Ember.computed(function () {
      ...
      leafletRequiredOptions.forEach(function (optionName) {
        (true && !(_this2.get(optionName)) && Ember.assert('`' + optionName + '` is a required option but its value was `' + _this2.get(optionName) + '`', _this2.get(optionName)));
        ...
        _this4._eventHandlers[eventName] = function (e) {
          ...
          Ember.run(function () {
            ...
            if (typeof _this5[methodName] === 'function') {
              Ember.run(_this5, _this5[methodName], e);
            }
          });
        };
    ...
    _addObservers: function _addObservers() {
      ...
      this.get('leafletProperties').forEach(function (propExp) {
        ...
        _this7._observers[property] = function () {
          ...
          (_layer$leafletPropert = this._layer[leafletProperty]).call.apply(_layer$leafletPropert, [this._layer, value].concat(_toConsumableArray(propertyParams)));
        };
